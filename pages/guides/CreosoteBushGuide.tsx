...
import { ArrowLeft, Droplets, Leaf, Heart, Sparkles, Shield, Wind, ShoppingBag } from 'lucide-react';
import SEOHead from '../../components/SEOHead';
import { getArticleSchema, getFAQSchema, getBreadcrumbSchema } from '../../lib/schema';

// FAQ data for schema
const creosoteBushFAQs = [
    {
        question: 'What is Creosote Bush Tincture?',
        answer: 'Creosote Bush Tincture (also known as Chaparral) is an all-natural herbal supplement made from the leaves of the Larrea P plant in organic cane spirits and distilled water. It is an ancient desert medicine.'
    },
    {
        question: 'What are the benefits of Creosote Bush?',
        answer: 'Benefits include immune boosting, skin health support for psoriasis, eczema, and acne, anti-inflammatory properties, respiratory support for healthy lung function, and digestive support.'
    },
    {
        question: 'How do you take Creosote Bush Tincture internally?',
        answer: 'For internal use, add 10 to 30 drops to a glass of water or juice. Drink the mixture and can be taken 1-3 times per day.'
    },
    {
        question: 'How do you use Creosote Bush externally?',
        answer: 'For external use, dilute 3 to 10 drops with a carrier oil like coconut or almond oil. Apply to the affected area for skin conditions.'
    },
    {
        question: 'What is Chaparral used for traditionally?',
        answer: 'Chaparral (Creosote Bush) has been traditionally used by indigenous peoples in the desert Southwest for respiratory, digestive, and skin health support.'
    }
];
...
export default function CreosoteBushGuide() {
    return (
        <>
            <SEOHead
                title="Creosote Bush (Chaparral) Tincture Guide - Ancient Desert Medicine"
                description="Ancient desert medicine Creosote Bush (Chaparral) tincture for immune support, skin health, and respiratory wellness. Learn internal and external use."
                keywords={['Creosote Bush', 'Chaparral', 'desert medicine', 'skin health herbs', 'immune boosting herbs', 'respiratory herbs']}
                url="/guides/creosote-bush"
                schema={[
                    getArticleSchema({
                        title: 'Creosote Bush Tincture Guide',
                        slug: 'creosote-bush',
                        description: 'Ancient desert medicine for immune and skin health.',
                        publishDate: '2024-01-01',
                        modifiedDate: '2025-01-01'
                    }),
                    getFAQSchema(creosoteBushFAQs),
                    getBreadcrumbSchema([
                        { name: 'Home', url: '/' },
                        { name: 'Healing Guides', url: '/healing-guides' },
                        { name: 'Creosote Bush Tincture', url: '/guides/creosote-bush' }
                    ])
                ]}
            />
                ...
                <section className="relative py-20 px-4 overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
                            <Link
                                to="/offerings/chaparral-creosote-bush-herbal-tincture-antioxidant-in-a-bottle-1oz"
                            ...
                            <a
                                ...
                                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-800 to-yellow-700 hover:from-amber-700 hover:to-yellow-600 border border-amber-500/30 text-white rounded-xl font-semibold transition-all duration-300 shadow-lg shadow-amber-900/50"
                            >
