...
import { ArrowLeft, Droplets, Leaf, Shield, Heart, Sparkles, Flame, ShoppingBag } from 'lucide-react';
                ...
                <section className="relative py-20 px-4 overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
                            <Link
                                to="/offerings/cashew-bark-extract-anacardium-occidentale"
                            ...
                            <a
                                ...
                                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-700 to-orange-600 hover:from-amber-600 hover:to-orange-500 border border-amber-500/30 text-white rounded-xl font-semibold transition-all duration-300 shadow-lg shadow-amber-900/50"
                            >
