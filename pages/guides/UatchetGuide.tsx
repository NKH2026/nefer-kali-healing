...
const uatchetFAQs = [
    {
        question: 'What is Uatchet Tincture?',
        answer: 'Uatchet is a nervine tincture containing Black Reishi mushroom and Blue Vervain in organic cane spirits. It is named after the Kametic serpent goddess who protected Lower Kamit and embodies the mystical energy of Ketu, the South Node of shadow work and spiritual liberation.'
    },
    {
        question: 'What are the benefits of Uatchet Tincture?',
        answer: 'Benefits include anxiety reduction, improved sleep quality, stress relief through adaptogenic herbs, nervous system support, and immune system boosting from Black Reishi mushroom.'
    },
    {
        question: 'How do you take Uatchet Tincture?',
        answer: 'Begin with a small dose on the first day to allow your body to acclimate. Thereafter, use 11 drops twice daily, ideally 2-3 hours before bedtime. Adjust the dosage as needed as you become attuned to its effects.'
    },
    {
        question: 'What is Black Reishi mushroom?',
        answer: 'Black Reishi is a medicinal mushroom recognized for its sedative properties that aid in enhancing sleep quality. It also has adaptogenic qualities and is renowned for immune-boosting properties.'
    },
    {
        question: 'What is Blue Vervain used for?',
        answer: 'Blue Vervain is a nervine herb known for its calming effects, reducing anxiety and promoting tranquility. It helps strengthen and tone the nervous system, making it beneficial for stress-related issues.'
    }
];
...
export default function UatchetGuide() {
    return (
        <>
            <SEOHead
                title="Uatchet Nervine Tincture Guide - Anxiety & Sleep Support"
                description="Nervine tincture with Black Reishi mushroom and Blue Vervain for anxiety relief, sleep support, and nervous system health. Named after the Kametic serpent goddess."
                keywords={['Uatchet tincture', 'nervine herbs', 'Black Reishi mushroom', 'Blue Vervain', 'anxiety relief herbs', 'sleep support tincture']}
                url="/guides/uatchet-tincture"
                schema={[
                    getArticleSchema({
                        title: 'Uatchet Nervine Tincture Guide',
                        slug: 'uatchet-tincture',
                        description: 'Nervine tincture for anxiety relief and sleep support.',
                        publishDate: '2024-01-01',
                        modifiedDate: '2025-01-01'
                    }),
                    getFAQSchema(uatchetFAQs),
                    getBreadcrumbSchema([
                        { name: 'Home', url: '/' },
                        { name: 'Healing Guides', url: '/healing-guides' },
                        { name: 'Uatchet Tincture', url: '/guides/uatchet-tincture' }
                    ])
                ]}
            />
