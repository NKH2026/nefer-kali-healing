    ...
    return (
        <div className={`${className}`}>
            ...
            <div className="relative w-full max-w-md mx-auto px-2">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-2 lg:gap-4">
                    ...
                    <div className="hidden lg:block text-left w-24 xl:w-28 flex-shrink-0">
                        <span className="text-amber-300 font-bold text-lg xl:text-xl tracking-wide">LUTEAL</span>
                        <span className="block text-amber-200/70 text-xs xl:text-sm">Days 16-28</span>
                    </div>
                ...
                <div className="flex lg:hidden justify-between px-4 mt-3">
                    <div className="text-left">
                        <span className="text-amber-300 font-bold text-base tracking-wide">LUTEAL</span>
                        <span className="block text-amber-200/70 text-xs">Days 16-28</span>
                    </div>
            ...
            <div className="mt-6 lg:mt-10 max-w-xl mx-auto px-2">
                <div className="bg-gradient-to-r from-amber-600/30 to-pink-600/30 border-2 border-amber-400/50 rounded-xl p-3 sm:p-5 mb-4 lg:mb-6 shadow-lg">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <div className="bg-green-900/30 border border-green-500/40 rounded-lg p-2.5 sm:p-3 flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                <span className="text-green-400 font-bold block text-sm sm:text-base">▶ START: Day 16</span>
                                <span className="text-white text-xs sm:text-sm">48 hours after ovulation</span>
                            </div>
                        </div>
                        <div className="bg-red-900/30 border border-red-500/40 rounded-lg p-2.5 sm:p-3 flex items-center gap-2 sm:gap-3">
                            ...
                            <div>
                                <span className="text-red-400 font-bold block text-sm sm:text-base">■ STOP: Day 2</span>
